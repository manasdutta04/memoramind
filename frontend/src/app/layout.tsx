        ...
        <header className="sticky top-0 z-30 border-b-4 border-night bg-base">
          <nav className="mx-auto flex h-20 w-full max-w-6xl items-center justify-between px-5">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="https://github.com/manasdutta04/memoramind" target="_blank" rel="noopener noreferrer" className="bg-white flex items-center gap-2 border-2 border-night px-4 py-2 text-sm font-bold uppercase transition hover:bg-night hover:text-white hover:shadow-brutal-sm">
